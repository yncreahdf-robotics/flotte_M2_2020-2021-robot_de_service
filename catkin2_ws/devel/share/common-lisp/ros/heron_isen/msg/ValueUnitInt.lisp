...
(cl:defmethod cl:initialize-instance :after ((m <ValueUnitInt>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ValueUnitInt)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name heron_isen-msg:<ValueUnitInt> is deprecated: use heron_isen-msg:ValueUnitInt instead.")))
