...
(cl:defmethod cl:initialize-instance :after ((m <ValueUnitFloat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ValueUnitFloat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name coulomb_counter_cc75_ros-msg:<ValueUnitFloat> is deprecated: use coulomb_counter_cc75_ros-msg:ValueUnitFloat instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <ValueUnitFloat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader coulomb_counter_cc75_ros-msg:value-val is deprecated.  Use coulomb_counter_cc75_ros-msg:value instead.")
  (value m))

(cl:ensure-generic-function 'unit-val :lambda-list '(m))
(cl:defmethod unit-val ((m <ValueUnitFloat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader coulomb_counter_cc75_ros-msg:unit-val is deprecated.  Use coulomb_counter_cc75_ros-msg:unit instead.")
  (unit m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ValueUnitFloat>)))
  ...
  "coulomb_counter_cc75_ros/ValueUnitFloat")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ValueUnitFloat)))
  "Returns string type for a message object of type 'ValueUnitFloat"
  "coulomb_counter_cc75_ros/ValueUnitFloat")
