...
(cl:defmethod cl:initialize-instance :after ((m <ValueUnitFloat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ValueUnitFloat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name heron-msg:<ValueUnitFloat> is deprecated: use heron-msg:ValueUnitFloat instead.")))
