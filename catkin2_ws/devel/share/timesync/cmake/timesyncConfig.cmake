...
if("TRUE" STREQUAL "TRUE")
  set(timesync_SOURCE_PREFIX /home/nvidia/catkin2_ws/src/timesync_ros)
  set(timesync_DEVEL_PREFIX /home/nvidia/catkin2_ws/devel)
  set(timesync_INSTALL_PREFIX "")
  set(timesync_PREFIX ${timesync_DEVEL_PREFIX})
else()
  set(timesync_SOURCE_PREFIX "")
  set(timesync_DEVEL_PREFIX "")
  set(timesync_INSTALL_PREFIX /home/nvidia/catkin2_ws/install)
...
if(NOT "/home/nvidia/catkin2_ws/devel/include;/home/nvidia/catkin2_ws/src/timesync_ros/include " STREQUAL " ")
  set(timesync_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/catkin2_ws/devel/include;/home/nvidia/catkin2_ws/src/timesync_ros/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Juraj Oršulić <juraj.orsulic@fer.hr>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'timesync' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'timesync' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin2_ws/src/timesync_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT timesync_NUM_DUMMY_TARGETS)
      set(timesync_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::timesync::wrapped-linker-option${timesync_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR timesync_NUM_DUMMY_TARGETS "${timesync_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::timesync::wrapped-linker-option${timesync_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND timesync_LIBRARIES "${interface_target_name}")
...
set(timesync_EXPORTED_TARGETS "timesync_generate_messages_cpp;timesync_generate_messages_eus;timesync_generate_messages_lisp;timesync_generate_messages_nodejs;timesync_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${timesync_dep}_FOUND)
      find_package(${timesync_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${timesync_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
