    ...
    def done_cb(self, status, result):
        ...
        if status == 3:
            ...
            while True:
                ...
                data, bbox, _ = detector.detectAndDecode(img, 4)
                ...
                if bbox is not None:
                    ...
                    while !data:
                        print("tourne sur toi meme")

                    while data:
                        if (bbox[0][0][1] > bbox[1][0][1] and bbox[2][0][1] > bbox[3][0][1]):
                            print("rotate a droite")
                        if (bbox[0][0][1] < bbox[1][0][1] and bbox[2][0][1] < bbox[3][0][1]):
                            print("rotate a gauche")
                        if (largeur - bbox[1][0][0] < bbox[0][0][0]):
                            print("translate a droite")
                        if (largeur - bbox[1][0][0] > bbox[0][0][0]):
                            print("translate a gauche")
