...
"""autogenerated by genpy from robotino_local_move/LocalMoveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class LocalMoveActionFeedback(genpy.Message):
  _md5sum = "1f9e15a8ad4bb41c7a2368d136551027"
  _type = "robotino_local_move/LocalMoveActionFeedback"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LocalMoveActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = robotino_local_move.msg.LocalMoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robotino_local_move.msg.LocalMoveFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3f().pack(_x.feedback.forward_dist_x, _x.feedback.forward_dist_y, _x.feedback.rotation_dist))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.forward_dist_x, _x.feedback.forward_dist_y, _x.feedback.rotation_dist,) = _get_struct_3f().unpack(str[start:end])
      return self
