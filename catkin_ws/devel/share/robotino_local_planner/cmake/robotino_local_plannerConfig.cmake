...
if("TRUE" STREQUAL "TRUE")
  set(robotino_local_planner_SOURCE_PREFIX /home/robotino/catkin_ws/src/robotino_local_planner)
  set(robotino_local_planner_DEVEL_PREFIX /home/robotino/catkin_ws/devel)
  ...
  set(robotino_local_planner_INSTALL_PREFIX /home/robotino/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/robotino_local_planner " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/robotino_local_planner' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robotino_local_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'robotino_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotino/catkin_ws/src/robotino_local_planner/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robotino_local_planner_NUM_DUMMY_TARGETS)
      set(robotino_local_planner_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robotino_local_planner::wrapped-linker-option${robotino_local_planner_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robotino_local_planner_NUM_DUMMY_TARGETS "${robotino_local_planner_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robotino_local_planner::wrapped-linker-option${robotino_local_planner_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robotino_local_planner_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robotino_local_planner_dep}_FOUND)
      find_package(${robotino_local_planner_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robotino_local_planner_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
