...
namespace robotino_local_planner
{
	...
	void RobotinoLocalPlanner::initialize( std::string name, tf::TransformListener* tf, costmap_2d::Costmap2DROS* costmap_ros )
	{
		...
		private_nh.param("max_linear_vel", max_linear_vel_, 0.7);
		private_nh.param("min_linear_vel", min_linear_vel_, 0.3 );
		private_nh.param("max_rotation_vel", max_rotation_vel_, 1.5 );
		private_nh.param("min_rotation_vel", min_rotation_vel_, 0.2 );
