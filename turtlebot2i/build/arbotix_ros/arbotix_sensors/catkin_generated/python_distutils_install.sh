...
echo_and_run cd "/home/turtlebot/turtlebot2i/src/arbotix_ros/arbotix_sensors"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/turtlebot2i/build/arbotix_ros/arbotix_sensors" \
    install \
    $DESTDIR_ARG \
