...
(cl:defmethod cl:initialize-instance :after ((m <PickAndPlaceGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PickAndPlaceGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot2i_block_manipulation-msg:<PickAndPlaceGoal> is deprecated: use turtlebot2i_block_manipulation-msg:PickAndPlaceGoal instead.")))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_block_manipulation-msg:frame-val is deprecated.  Use turtlebot2i_block_manipulation-msg:frame instead.")
  (frame m))

(cl:ensure-generic-function 'z_up-val :lambda-list '(m))
(cl:defmethod z_up-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_block_manipulation-msg:z_up-val is deprecated.  Use turtlebot2i_block_manipulation-msg:z_up instead.")
  (z_up m))

(cl:ensure-generic-function 'gripper_open-val :lambda-list '(m))
(cl:defmethod gripper_open-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_block_manipulation-msg:gripper_open-val is deprecated.  Use turtlebot2i_block_manipulation-msg:gripper_open instead.")
  (gripper_open m))

(cl:ensure-generic-function 'gripper_closed-val :lambda-list '(m))
(cl:defmethod gripper_closed-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_block_manipulation-msg:gripper_closed-val is deprecated.  Use turtlebot2i_block_manipulation-msg:gripper_closed instead.")
  (gripper_closed m))

(cl:ensure-generic-function 'pickup_pose-val :lambda-list '(m))
(cl:defmethod pickup_pose-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_block_manipulation-msg:pickup_pose-val is deprecated.  Use turtlebot2i_block_manipulation-msg:pickup_pose instead.")
  (pickup_pose m))

(cl:ensure-generic-function 'place_pose-val :lambda-list '(m))
(cl:defmethod place_pose-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_block_manipulation-msg:place_pose-val is deprecated.  Use turtlebot2i_block_manipulation-msg:place_pose instead.")
  (place_pose m))

(cl:ensure-generic-function 'topic-val :lambda-list '(m))
(cl:defmethod topic-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_block_manipulation-msg:topic-val is deprecated.  Use turtlebot2i_block_manipulation-msg:topic instead.")
  (topic m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PickAndPlaceGoal>)))
  ...
  "turtlebot2i_block_manipulation/PickAndPlaceGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PickAndPlaceGoal)))
  "Returns string type for a message object of type 'PickAndPlaceGoal"
  "turtlebot2i_block_manipulation/PickAndPlaceGoal")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PickAndPlaceGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal definition~%string frame~%float32 z_up~%float32 gripper_open~%float32 gripper_closed~%geometry_msgs/Pose pickup_pose~%geometry_msgs/Pose place_pose~%string topic~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PickAndPlaceGoal)))
  "Returns full string definition for message of type 'PickAndPlaceGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#goal definition~%string frame~%float32 z_up~%float32 gripper_open~%float32 gripper_closed~%geometry_msgs/Pose pickup_pose~%geometry_msgs/Pose place_pose~%string topic~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
