...
(cl:defmethod cl:initialize-instance :after ((m <BlockPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BlockPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot2i_marker_manipulation-msg:<BlockPose> is deprecated: use turtlebot2i_marker_manipulation-msg:BlockPose instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <BlockPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_marker_manipulation-msg:position-val is deprecated.  Use turtlebot2i_marker_manipulation-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <BlockPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_marker_manipulation-msg:orientation-val is deprecated.  Use turtlebot2i_marker_manipulation-msg:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <BlockPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot2i_marker_manipulation-msg:color-val is deprecated.  Use turtlebot2i_marker_manipulation-msg:color instead.")
  (color m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BlockPose>)))
  ...
  "turtlebot2i_marker_manipulation/BlockPose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BlockPose)))
  "Returns string type for a message object of type 'BlockPose"
  "turtlebot2i_marker_manipulation/BlockPose")
