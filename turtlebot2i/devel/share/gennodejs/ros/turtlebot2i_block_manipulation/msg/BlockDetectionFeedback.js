...
class BlockDetectionFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BlockDetectionFeedback(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BlockDetectionFeedback(null);
    return resolved;
    }
};

module.exports = BlockDetectionFeedback;
