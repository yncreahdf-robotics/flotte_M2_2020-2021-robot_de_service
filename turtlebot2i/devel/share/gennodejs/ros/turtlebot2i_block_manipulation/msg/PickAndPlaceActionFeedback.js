...
class PickAndPlaceActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PickAndPlaceFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PickAndPlaceFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PickAndPlaceActionFeedback(null);
    ...
    data.feedback = PickAndPlaceFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PickAndPlaceActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PickAndPlaceFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PickAndPlaceFeedback()
    }
...
module.exports = PickAndPlaceActionFeedback;
