...
class BlockDetectionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new BlockDetectionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BlockDetectionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BlockDetectionActionFeedback(null);
    ...
    data.feedback = BlockDetectionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BlockDetectionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = BlockDetectionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new BlockDetectionFeedback()
    }
...
module.exports = BlockDetectionActionFeedback;
