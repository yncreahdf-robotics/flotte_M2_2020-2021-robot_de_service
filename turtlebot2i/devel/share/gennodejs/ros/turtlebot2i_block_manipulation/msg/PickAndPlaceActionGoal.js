...
class PickAndPlaceActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new PickAndPlaceGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PickAndPlaceGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PickAndPlaceGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PickAndPlaceActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PickAndPlaceGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PickAndPlaceGoal()
    }
...
module.exports = PickAndPlaceActionGoal;
