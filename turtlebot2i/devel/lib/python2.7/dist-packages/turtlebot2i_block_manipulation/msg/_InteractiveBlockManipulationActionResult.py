...
"""autogenerated by genpy from turtlebot2i_block_manipulation/InteractiveBlockManipulationActionResult.msg. Do not edit."""
import codecs
import sys
...
class InteractiveBlockManipulationActionResult(genpy.Message):
  ...
  _type = "turtlebot2i_block_manipulation/InteractiveBlockManipulationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','turtlebot2i_block_manipulation/InteractiveBlockManipulationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = turtlebot2i_block_manipulation.msg.InteractiveBlockManipulationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = turtlebot2i_block_manipulation.msg.InteractiveBlockManipulationResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.pickup_pose.position.x, _x.result.pickup_pose.position.y, _x.result.pickup_pose.position.z, _x.result.pickup_pose.orientation.x, _x.result.pickup_pose.orientation.y, _x.result.pickup_pose.orientation.z, _x.result.pickup_pose.orientation.w, _x.result.place_pose.position.x, _x.result.place_pose.position.y, _x.result.place_pose.position.z, _x.result.place_pose.orientation.x, _x.result.place_pose.orientation.y, _x.result.place_pose.orientation.z, _x.result.place_pose.orientation.w,) = _get_struct_14d().unpack(str[start:end])
      return self
